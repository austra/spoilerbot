...
module SpoilerBot
  class Web < Sinatra::Base
    ...
    def get_death
      deaths = ["A broken heart. Followed quickly by a mace to the skull.", "Accidentally dropped by Hodor.", "Accidentally roll over too far when sleeping in Eyrie Prison.", "Arrow through the jugular.", "Assassinated by shadow demon baby.", "Ax to the face.", "Beheaded at Joffrey&rsquo;s behest.", "Beheaded by Theon.", "Beheaded for deserting the Knights Watch.", "Betrayed by whom you trust most.", "Bored to death by Catelyn.", "Burned at the stake as punishment for tricking Daenerys.", "Cersei tells Jaime she slept with you.", "Choked out by imprisoned Jaime Lannister.", "Chucked into a crazy hole &mdash; a.k.a. &ldquo;the moon door&rdquo; &mdash; by Bronn.", "Contract a disease at Littlefinger&rsquo;s.", "Crushed to death by giant.", "Disemboweled by the Hound.", "Dragged by a horse.", "Dragon lunch.", "Eat a bad horse heart.", "Eaten by direwolf.", "Exposure out in the desert with Daenerys.", "Face pushed in mud until you drown.", "Fall off the Wall.", "Fatal head wound from Tyrion&rsquo;s shield.", "Freeze to death North of the Wall.", "Hanged for disloyalty to throne.", "High cholesterol from a lifetime of eating auroch.", "Hot oil poured on you from above.", "Hugged to death by giant.", "Jaqen H&rsquo;ghar appears out of nowhere, takes your face, kills you.", "Killed for money by Bronn.", "Knocked off a tower by a flock of ravens.", "Leg axed off by Tyrion.", "Lethal dose of Cersei side-eye.", "Licked to death by aggressive mother direwolf.", "Malnutrition and poor dental hygiene.", "Mercy-smothered by Daenerys.", "Mistaken for Ned Stark, beheaded.", "Molten tin poured into ears.", "Molten gold poured over head.", "OD&rsquo;d on milk of the poppy.", "On the wrong end of a jousting match.", "Peanut allergy.", "Poisoned. By those you trusted.", "Rat torture: A bucket with a rat in it was fastened to your abdomen. To get out, the rat gnawed through your innards.", "Samwell Tarly accidentally shot you with a crossbow.", "Sat on own dagger.", "Sealed in ice and left to freeze/starve.", "Seduced and stabbed by Osha.", "Sepsis after being gored by a boar.", "Shot by Theon Greyjoy&rsquo;s bow and arrow.", "Sliced in half with Valyrian steel.", "Sniffled to death by Walder Frey&rsquo;s offspring.", "Soul frozen/destroyed by White Walkers.", "Stabbed and set on fire by Jon Snow.", "Stabbed by Arya Stark, for standing in her way. (Served you right.)", "Stabbed in the eye by Jamie Lannister.", "Stabbed to death by ten equally-aggressive armored knights.", "Suffocated underneath sleeping Hodor.", "Syphilis.", "Teased the Hound with a match.", "Throat ripped out by Khal Drogo.", "Throat slit by creepy magician in Q&rsquo;arth.", "Tortured to death by &ldquo;the tickler.&rdquo;", "Tried to put a funny hat on a direwolf.", "Underestimated Arya&rsquo;s skill with Needle.", "Unseamed from nave to chops. (That's how you died in Macbeth too.)", "Walloped to death with a mace.", "You have died of dysentery. Which you contracted on the Iron Islands."]
      msg = deaths.sample
      msg
    end
